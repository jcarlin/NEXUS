...
└── vault-ai-os/                 # Infrastructure — golden image builder
    ...
    ├── ansible/                 # Provisioning roles (site.yml + gpu.yml)
...
| **API Gateway** | FastAPI, httpx, SQLite, uvicorn | PostgreSQL, Celery+Redis | ✅ Complete (63 endpoints, 234 tests) |
...
| **Reverse Proxy** | Caddy (self-signed TLS) | ACME auto-TLS when internet enabled | Stage 2 |
| **Infrastructure** | Packer, Ansible, Ubuntu 24.04 LTS | — | ✅ Base + GPU stack validated |
...
| **Stage 2: Rev 1+2** | Pilot product: 38 API endpoints, chat UI, first-boot wizard, monitoring | 120–160 hrs | API ✅, UI ✅, Setup ✅, GPU ✅, Monitoring ✅ (64 endpoints, 239 tests) |
| **Stage 3: Rev 2** | Enterprise features: full API (57 endpoints), quarantine, updates, backup | 200–260 hrs | Planned |
