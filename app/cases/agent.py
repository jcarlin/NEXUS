...
def create_case_setup_nodes(llm_settings: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "parse_anchor_doc": log_agent_node("case_setup", "parse_anchor_doc", postgres_url=postgres_url)(
            parse_anchor_doc
        ),
        ...
        "extract_defined_terms": log_agent_node("case_setup", "extract_defined_terms", postgres_url=postgres_url)(
